...
const vec3 moonColor = sunColor * 65e-8;

const vec3 rayleighScatteringCoefficient = vec3(5.800e-6, 1.350e-5, 3.310e-5);
...
const float rayleighScaleHeight = 8.0e3; //Not accurate, done to fix sunrise and sunset.
...
#define skyQuality_I 12 //[4 8 12 16 32 64 128] Controls the quality of the atmosphere. Higher means a slower, but more realistic lookin' sky. Change the J steps after you change this.
